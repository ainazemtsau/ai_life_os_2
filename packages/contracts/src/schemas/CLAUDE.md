...
| `messages.schema.ts`  | EditMessageRequest, SiblingsResponse, ErrorResponse schemas | Validating message operations, API error handling |
| `utilities.schema.ts` | Utility-related schemas                             | Working with utility operations          |
